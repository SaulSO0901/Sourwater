    ...
    <div className="flex-col  mx-auto w-full  lg:h-[550px] md:h-[824px]  mt-24 bg-[#f2f1f0] ">
        ...
        <div className="flex-col justify-start  lg:max-w-[380px] md:max-w-[224px] w-full md:border-r-[.7px]  md:border-C7C5C ">
            ...
            <div className="flex-col md:max-w-[176px] lg:ml-4 w-full h-full justify-between md:items-center md:text-center   ">
              <ul className="flex-col w-full justify-center text-center lg:justify-start lg:text-start  ">
                <li className="flex w-full">
                  <p className="w-full text-xl font-medium">NEED HELP?</p>
                </li>
                <li className="w-full">
                  <p className="">Call Your Sales Engineer.</p>
                </li>
                <li className="w-full">
                  <a href="*" className="text-sm underline">
                    What is a Sales Engineers?
                  </a>
                </li>
                <li className="w-full">
                ...
                <li className="h-[38px] mt-2 items-center  bg-white">
                  <p className="h-full px-2 py-1 font-medium">
                    Cartd ID: 211XS09
                  </p>
                </li>
              </ul>
          ...
          <div className="flex   w-full mt-4   h-fit  justify-center lg:max-w-[379px]  md:max-w-[176px]  max-[767px]:py-4 max-[767px]:border-t-[.7px] max-[767px]:border-b-[.7px] max-[767px]:border-C7C5C ">
            <div className="mx-2">
              <AiOutlineFacebook
                size={40}
                className="lg:mx-2 cursor-pointer"
              ></AiOutlineFacebook>
            </div>
            <div className="mx-2">
              {" "}
        ...
        <div className="lg:flex  w-full grid grid-cols-2 max-[767px]:max-w-[767px]  max-[767px]:pr-6">
          <div className="flex-col lg:max-w-[218px] md:max-w-[207px]  max-[767px]:max-w-[355px]  w-full lg:ml-6">
            <ul>
              <Link to="/store">
                <li className="flex ">
                  <div className="w-full h-full py-2 px-2 text-lg font-bold cursor-pointer">
                    ABOUT SOURWATER
                  </div>
                </li>
                <li className="flex ">
                  <div className="w-full h-full py-2 px-2 cursor-pointer">
                    Carrers
                  </div>
                </li>
                <li className="flex ">
      ...
      <div className="flex w-full text-center justify-center border-t-[.7px] border-C7C5C">
        <p className="mt-2 text-sm">
          <a className="underline  font-medium">Sourwater Sound</a>, 5501 U.S.
          Hwy 30 W, Fort Wayne, IN 46818
          <a className="underline "> Get Directions</a> |
          <a className="underline"> Phone Hours</a> |
          <a className="underline "> Store Hours</a>
        </p>
      </div>
      ...
      <div className="flex-col w-full mt-4 text-center justify-center">
        ...
        <p className=" text-sm">
          ...
          <a className=" underline"> Phone Recording Policy.</a>{" "}
          <a className=" underline">Accessibility.</a>{" "}
          <a className=" underline"> Cookies Settings.</a>{" "}
          <a className=" underline">Do Not Sell Or Share My Information.</a>
        </p>
        <p className=" text-sm">
          If you have any questions, please call us at <a>(800) 224-4701</a>
        </p>
        <p className=" mt-4 text-sm">
          © 2024 Sweetwater - All rights reserved.
        </p>
        <p className=" text-sm">
          © Made by Saul Salazar Ozuna for academic purposes only.
        </p>
      </div>
    </div>
  );
