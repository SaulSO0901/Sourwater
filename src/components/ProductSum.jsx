...
const ProductSum = () => {
  ...
  return (
    <div className='w-full  mb-10 border-b-[.7px] border-b-C7C5C1'>
<div className='flex-col max-w-[1400px] w-full mx-auto md:px-4 '>
    ...
    <div className='flex-col w-full h-full   '>
     ...
     <p className='text-sm font-light text-[#362D2D]'>Solidbody Electric Guitar with Mahogany Body, Mahogany Neck, Ebony Fingerboard, and 2 Active Humbucking Pickups - Black Satin</p>
...
<p className='text-sm font-medium'>Item ID: EVULTUREBLKS</p>
    ...
    <div className='flex my-4'>
      <div className='flex-col w-[60px]   select-none'>
...
<div className='my-2 '>
 <img src={back} alt='front' className=' w-[60px] h-[60px] px-2' ></img> 
      ...
      <div className='max-w-[651px] w-full max-h-[750px] h-full select-none'>
<img src={front} className='w-[651px] h-[750px] px-16'></img>
</div>

<div className='max-w-[560px] w-full h-full ml-16'>
...
<p className='mx-1 text-[#ED2C2C]'>$4,899.00</p>!<p className='mx-1 text-[#0072BA] cursor-pointer'>Learn more.</p>
</div>

<div className='flex w-full mt-4 pb-4 border-b-[.7px] border-b-C7C5C'>
<div className='flex w-full justify-start items-center cursor-pointer'><GiGuitarBassHead size={30}></GiGuitarBassHead><p className='mx-1 text-sm'>37 point<br/>Inspection</p></div>
<div className='flex w-full justify-startr items-center cursor-pointer'><FaTruck size={30}></FaTruck><p className='mx-1 text-sm'>Fast <br/> Shipping</p></div>
<div className='flex w-full justify-start items-center cursor-pointer'><BiSupport size={30}></BiSupport><p className='mx-1 text-sm'>Free <br/> Support</p></div>
<div className='flex  w-full justify-start items-center cursor-pointer'><GoShieldCheck size={30}></GoShieldCheck><p className='mx-1  text-sm'>3-year <br/> Warranty</p></div>
