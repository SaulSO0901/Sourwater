...
<div className='flex h-full px-28 items-center  border-b-[2px] border-b-[#0072BA]'><p className='text-[#0072BA] font-medium'>Description</p></div>
<div className='flex h-full px-28 items-center border-b-[2px] border-b-[#0072BA]  '><p className=' text-[#0072BA] font-medium'>Specs</p></div>
<div className='flex  h-full px-28 items-center  border-b-[2px] border-b-[#0072BA]  '>    
...
<div className='flex-col max-w-[1400px] w-full mx-auto mt-6 md:px-4'>
    <div className='flex w-full justify-center mx-auto '>
<h2 className=' text-4xl font-medium'>High-performance James Hetfield Signature</h2>
</div>

<div className='flex mt-14 py-4 border-b-[.7px] border-b-C7C5C1 '>
...
<div className='w-full py-4 border-b-[.7px] border-b-C7C5C1'>

<h2 className=' text-4xl font-medium'>Tech Specs</h2>
</div>

<table className='max-w-[1400px] w-full'>
{/********************************************************************************/}
...
<tr className='flex h-10 bg-[#f2f1f01e]'>
<td className='w-[199px] font-medium'>Fingerboard Material</td>
