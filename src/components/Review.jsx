...
const Review = () => {
  ...
  return (
    <div onMouseEnter={handleRev} id='review' className='max-w-[1400px] w-full mx-auto mt-10  '>
        <h2 className='w-full  mx-auto mb-6 text-center lg:text-start text-4xl  font-medium  text-[#362D2D]'>Customers reviews</h2>
...
<div className='flex-col w-fit mx-auto '>
  ...
  <button className=' p-4 px-6 mt-4  rounded text-xl font-bold text-white  bg-[#0072ba] hover:bg-[#4a4c8b] '>Write your review</button>
  </div>
        </div>
