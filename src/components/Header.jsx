...
import bf from "../assets/ads/ad.JPG";
import {
  AiFillCaretDown,
  AiFillCaretUp,
  AiFillCaretRight,
...
const Header = () => {
  ...
  return (
    <div className="flex h-10 my-2 border-b-[.7px] border-b-C7C5C  items-center justify-center md:px-4 h-14 xl:h-full  hidden md:flex      ">
              ...
              <div className="flex w-72 h-[579px]     ">
                <div className="flex-col w-full  ">
                  <ul className="text-[#362D2D]">
                    <li
                      onMouseEnter={handleGtr}
                      className="flex items-center justify-between p-[6px] border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] "
                    >
                    ...
                    <li
                      onMouseEnter={handleMic}
                      className="flex items-center justify-between p-[7px] border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] "
                    >
                    ...
                    <li
                      onMouseEnter={handlePF}
                      className="flex items-center justify-between p-[7px] border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] "
                    >
                      <p className="text-[#362D2D]  ">
                        Explore our <b>product finders</b>
                      </p>
                      {pf ? (
                        <AiFillCaretLeft className="" size={15} />
                      ) : (
                ...
                <div
                  ...
                  className={
                    gtr
                      ? "flex w-0 -my-[2px] cursor-pointer top-0 ease-in-out duration-0 z-10"
                      : "ease-in-out duration-0 fixed left-[-100%]"
                  }
                >
                  <div
                    onMouseEnter={handleAd}
                    className="flex-col  bg-white  border-C7C5C1 border-[.1px] "
                  >
                    <div className="flex items-center justify-between hover:bg-[#EFEFEF]  border-b-[.7px] border-b-C7C5C1">
                      <h1
                        onMouseEnter={handleHdr}
                        className="p-2 w-[348px] text-2xl   text-[#362D2D] hover:text-[#0072BA] "
                      >
                        Guitars
                      </h1>
                    ...
                    <div className="flex border-b-[.0px] border-b-C7C5C1 h-full   ">
                      <div className=" w-56  ">
                        <ul className="">
                          <li
                            ...
                            className="flex justify-between  p-[7px] border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] "
                          >
                      ...
                      <ul
                        className={
                          ad
                            ? "flex-col border-l-[.1px] h-[532px]  w-56 items-center justify-center "
                            : "hidden"
                        }
                      >
                      ...
                      <ul>
                        <div
                          className={
                            one
                              ? "-my-[1px]  w-0 h-0 flex cursor-pointer top-0  h-full  ease-in-out duration-0"
                              : "ease-in-out duration-0 fixed left-[-100%]"
                          }
                        >
                          <div
                            onMouseLeave={handleOne2}
                            className="flex-col  border-b-[.0px] border-r-[.0px] h-[529px] border-C7C5C1 border-[.1px] "
                          >
                ...
                <div
                  ...
                  className={
                    std
                      ? "w-0  flex -my-[2px] cursor-pointer top-0  h-[583px] ease-in-out duration-0  z-10"
                      : "ease-in-out duration-0 fixed left-[-100%]"
                  }
                >
                  <div
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D]  hover:text-[#0072BA]">
                                    <p className="   ">
                                      Audio Engineering Instructional Books
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA]">
                            ...
                            <div className="flex    ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className=" ">
                                      Headset Microphone Wireless Systems
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className="">
                            ...
                            <div className="flex    ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] font-medium hover:text-[#0072BA] ">
                                    <p className=" ">
                                      View all Eurorack & Modular Synthesizers
                                    </p>
                                  </li>
                                </ul>
                                <div
                    ...
                    <div className="flex border-b-[.0px] border-b-C7C5C1 h-full   ">
                            ...
                            <div className="flex    ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className="   ">
                                      Bass Guitar Amp Accessories
                                    </p>
                                  </li>

                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] font-medium hover:text-[#0072BA] ">
                                    <p className=" ">
                                      View all Bass Guitar Amps
                                    </p>
                                  </li>
                                </ul>
                                <div
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] font-medium hover:text-[#0072BA]">
                                    <p className="   ">
                                      View All Bass Guitar Pedals & Effects
                                    </p>
                                  </li>
                                </ul>
                                <div
                      ...
                      <ul>
                        <div
                          className={
                            four
                              ? "-my-[1px]  w-0 h-0 flex cursor-pointer top-0   ease-in-out duration-0"
                              : "ease-in-out duration-0 fixed left-[-100%]"
                          }
                        >
                          <div
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className="">
                                      Meditation & Music Therapy Instruments
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className="">
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className=" ">
                                      iPad/Iphone DJ Mixers/Controllers
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                            ...
                            <div className="flex    ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className="   ">
                                      Brass cases, Covers, & Bags
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] font-medium hover:text-[#0072BA] ">
                                    <p className=" ">
                                      View all Brass Instruments
                                    </p>
                                  </li>
                                </ul>
                                <div
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] font-medium hover:text-[#0072BA]">
                                    <p className="   ">
                                      View All Orchestral Strings Instruments
                                    </p>
                                  </li>
                                </ul>
                                <div
                    ...
                    <div className="flex border-b-[.0px] border-b-C7C5C1 h-full   ">
                      <div className=" w-56  ">
                        <ul className="">
                          ...
                          >
                            <p className="">
                              Commercial Audio & Installed Sound
                            </p>
                            <MdChevronRight size={20}></MdChevronRight>
                          </li>
                      ...
                      >
                        <li className="flex items-center justify-center  h-[529px] p-[22px] "></li>
                      </ul>
                      <ul>
                        <div
                          className={
                            ...
                            <div onMouseLeave={handleAd} className="flex ">
                              <div className="flex w-56 ">
                                <ul className="flex-col w-[344px]">
                                  ...
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                                    <p className=" ">
                                      Music Education & Learning Books
                                    </p>
                                  </li>
                                  <li className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] ">
                ...
                >
                  <div className="flex-col bg-white  border-C7C5C1 border-[.1px] ">
                    <div className="flex items-center justify-between hover:bg-[#EFEFEF]  border-b-[.7px] border-b-C7C5C1">
                      <h1
                        onMouseEnter={handleHdr}
                        className="p-2 w-[448px] text-2xl  text-[#362D2D] hover:text-[#0072BA] "
                      >
                        Product Finders
                      </h1>
                    </div>
                      ...
                      <div className=" w-56  ">
                        <ul className="">
                          <div onMouseEnter={handleAd}>
                            ...
                            <li className="flex justify-between  p-[7px] hover:bg-[#EFEFEF]   text-[#362D2D] hover:text-[#0072BA]">
                              <p className="  ">
                                Westone Audio In-ear Customizer
                              </p>
                            </li>
                            <li className="flex justify-between  p-[7px] hover:bg-[#EFEFEF]   text-[#362D2D] hover:text-[#0072BA]">
      ...
      <div className="flex max-w-[192px]   min-w-[122px]   w-full h-[40px]   items-center justify-center hover:bg-[#EFEFEF]   text-[#362D2D] hover:text-[#0072BA] cursor-pointer">
        <Link
          className="flex w-full h-full items-center justify-center text-center"
          to="/store"
        >
          <p className="w-full h-full py-2 font-medium font-medium">
            What's New
          </p>
        </Link>{" "}
      </div>
      ...
      <Link
        to="/store"
        onMouseEnter={handleDeal}
        onTouchStart={handleDeal}
        onMouseLeave={handleDeal2}
        className="flex max-w-[161px] min-w-[88px]   w-full h-[40px]  justify-center items-center hover:bg-[#EFEFEF]   text-[#362D2D] hover:text-[#0072BA] cursor-pointer"
      >
        ...
        <div className="flex-col items-center  ">
          ...
          >
            <div className=" absolute block  xl:-mx-[92px] lg:-mx-[63px] xl:my-5 lg:my-[27px] md:-mx-[56px] md:my-[27px] w-60 border-C7C5C1 border-[.1px] bg-white items-center justify-center text-[#362D2D]">
              <div
                onMouseEnter={handleOne2}
                className="flex  h-12 justify-center items-center hover:bg-[#EFEFEF] border-b-[.7px] border-b-C7C5C1"
              >
                <h1 className=" text-2xl text-[#362D2D]">
                  <b>DEAL</b>ZONE
                </h1>
              </div>
              <div className="flex">
                <div className="flex-col w-full">
                  <ul className="">
                    <li
                      onMouseEnter={handleOne}
                      className="flex p-2 justify-between  border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] "
                    >
                      ...
                      >
                        <div
                          onMouseLeave={handleOne2}
                          className="flex-col bg-white mx-[63px]  -my-[56px] h-fit border-C7C5C1 border-[.1px]"
                        >
                    ...
                    <li
                      onMouseEnter={handleOne2}
                      className="p-2  border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] "
                    >
      ...
      <Link
        to="/store"
        onMouseEnter={handleUG}
        onTouchStart={handleUG}
        onMouseLeave={handleUG2}
        className="flex max-w-[197px] min-w-[126px]    w-full h-[40px]    justify-center items-center hover:bg-[#EFEFEF]   text-[#362D2D] hover:text-[#0072BA] cursor-pointer"
      >
        <p className="font-medium">Used Gear</p>
        <div className="flex-col items-center  ">
          <div
            className={
              ug
              ...
              <div className="flex">
                <div className="flex-col w-full">
                  <ul className="">
                      ...
                      >
                        ...
                        >
                          <ul className="flex-col  w-[237px] ">
                            ...
                            <li className="p-2  border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] ">
                              <p className="text-[#362D2D]  ">
                                Used Keyboards & Synthesizers
                              </p>
                            </li>
                            <li className="p-2  border-b-[.7px] border-b-C7C5C1 hover:bg-[#EFEFEF] hover:text-[#0072BA] ">
                              <p className="text-[#362D2D] ">
                                Used Microphones & Wireless
                              </p>
                            </li>
                            <li className="p-2   hover:bg-[#EFEFEF] hover:text-[#0072BA] ">
                              <p className="text-[#362D2D]  ">
                                Used Live Sound & Lighting
                              </p>
                            </li>
                            <li className="p-2   hover:bg-[#EFEFEF] hover:text-[#0072BA] ">
                              <p className="text-[#362D2D]  ">
                                Used Studio & Recording
                              </p>
                            </li>
                            <li className="p-2   hover:bg-[#EFEFEF] hover:text-[#0072BA] ">
                              <p className="text-[#362D2D]  ">
                    ...
                    <li
                      onMouseEnter={handleTwo2}
                      className="p-2 hover:bg-[#EFEFEF] text-[#362D2D] hover:text-[#0072BA] border-b-[.7px] border-b-C7C5C1"
                    >
      ...
      <div className="flex  h-[40px] max-w-[160px]  min-w-[88px]  w-full justify-center items-center text hover:bg-[#EFEFEF]  text-[#362D2D] hover:text-[#0072BA] cursor-pointer">
        <Link
          className="flex w-full h-full items-center justify-center text-center"
          to="/store"
        >
          <p className="w-full h-full py-2 font-medium">Rentals</p>
        </Link>
      </div>
      <div className="flex  h-[40px] max-w-[227px] min-w-[156px]   w-full  justify-center items-center hover:bg-[#EFEFEF]  text-[#362D2D] hover:text-[#0072BA] cursor-pointer">
        <Link
          className="flex w-full h-full items-center justify-center text-center"
          to="/store"
        >
          <p className="w-full h-full py-2 font-medium">Articles & Videos</p>
        </Link>
      </div>
      <div className="flex  h-[40px] max-w-[177px]   w-full  justify-center items-center hover:bg-[#EFEFEF]  text-[#362D2D] hover:text-[#0072BA] cursor-pointer hidden lg:flex">
        <Link
          className="flex w-full h-full items-center justify-center text-center"
          to="/store"
        >
          <p className="w-full h-full py-2 font-medium"> Giveaway</p>
        </Link>
      </div>
      <div className="flex  h-[40px] max-w-[230px]   w-full  justify-center items-center hover:bg-[#EFEFEF]  text-[#362D2D] hover:text-[#0072BA] cursor-pointer hidden lg:flex">
        <Link
          className="flex w-full h-full items-center justify-center text-center"
          to="/store"
        >
          <p className="w-full h-full py-2 font-medium ">Sourwater Card</p>
        </Link>
      </div>
    </div>
  );
