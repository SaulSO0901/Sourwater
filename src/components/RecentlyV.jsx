...
const RecentlyV = () => {
  ...
  return (
    <div className='flex-col  relative max-w-[1400px] w-full max-[397px]:mt-60 md:mt-20 mt-36 mx-auto text-center -z-10 '>
    ...
    <img className='flex h-[80px] mx-10 -z-0' src={image} alt="gallery_image" />
  </Link>
          ))}
        </div>
