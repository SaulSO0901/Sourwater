...
import logo from "../assets/navbar/logoMB.png";
  ...
  return (
    <div className="flex-col relative  md:hidden  w-full z-50   ">
      <div
        className={
          nav
            ? 'flex fixed justify-between items-center h-[60px] w-full mx-auto   md:hidden  bg-white   text-black z-50" '
      ...
      >
        ...
        <div className="flex items-center h-[60px] ">
          ...
          <div
            onClick={handleNav}
            className="block h-full md:hidden px-4 py-6 hover:bg-[#EFEFEF] "
          >
          ...
          <div
            className={
              nav
                ? "fixed w-[100%] h-full left-0 top-[60px] bg-white border-r border-r-[#C7C5C] ease-in-out duration-500  z-20 "
