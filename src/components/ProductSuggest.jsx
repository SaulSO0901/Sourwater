...
const ProductSuggest = () => {
  ...
  return (
    <div  className='flex-col max-w-[1400px] w-full md:mt-20 max-[425px]:border-t-[#C7C5C1]  mx-auto text-center '>
      ...
      <div className='flex  mt-12'>
        ...
        <div className="flex md:h-[252px] max-[425px]:h-[196px] items-start overflow-x-scroll scroll-smooth select-none   " ref={scrollRef}>
  ...
  ,images.trend9,images.trend10,images.trend11,images.trend12].map((image, index) => (
    <Link to='/product' className="flex relative h-32 w-[186px] md:first:ml-[80px] mx-1  justify-center  " key={`gallery_image-${index = 1}`}>
    <img className='flex h-[120px] mx-28 max-[425px]:ml-12  ' src={image} alt="gallery_image" />
      ...
      <div onClick={() => scroll('right')} className="flex object-cover w-[80px] h-[228px] max-[3440px]:ml-[1320px] 2xl:right-auto  max-[1024px]:right-4 md:right-4 max-[425px]:hidden mx-auto md:absolute items-center cursor-pointer rounded-md bg-white mix-blend-luminosity  opacity-95  backdrop-blur-sm z-20 ">
