...
<div className='lg:flex  lg:max-w-[1370px] md:max-w-[738px] max-[638px]:max-w-[395px] w-full justify-center mt-4 mx-auto lg:px-4 sm:grid sm:grid-cols-3   md:grid md:grid-cols-3 max-[638px]:grid max-[638px]:grid-cols-2  '>
    ...
    <a href='*' className='flex-col max-w-[245px] w-full justify-center items-center'>
    ...
    <a href='*' className='flex-col max-w-[195px] md:max-w-[245px] w-full justify-center items-center'>
    ...
    <a href='*' className='flex-col  max-w-[195px] max-w-[245px] w-full  justify-center items-center'>
