...
<div className='lg:flex  lg:max-w-[1370px] md:max-w-[738px] max-[638px]:max-w-[395px] w-full justify-center mt-4 mx-auto lg:px-4 sm:grid sm:grid-cols-3   md:grid md:grid-cols-3 max-[638px]:grid max-[638px]:grid-cols-2  '>
    ...
    <Link to='/product' className='flex-col max-w-[245px] w-full justify-center items-center'>
        <div className='  h-7 w-7 md:mx-4 rounded-full bg-blue-900'><p className='p-1 text-white text-xs'>1</p></div>
    ...
    <Link to='/product' className='flex-col max-w-[245px] w-full justify-center items-center'>
        <div className=' h-7 w-7  md:mx-4 rounded-full bg-blue-900  '><p className='p-1 text-white text-xs'>2</p></div>
    ...
    <Link to='/product' className='flex-col max-w-[245px] w-full justify-center items-center'>
        <div className=' h-7 w-7  md:mx-4  rounded-full bg-blue-900 '><p className='p-1 text-white text-xs'>3</p></div>
    ...
    <Link to='/product'  className='flex-col max-w-[195px] md:max-w-[245px] w-full justify-center items-center'>
        <div className='  h-7 w-7  md:mx-4 rounded-full bg-blue-900 '><p className='p-1 text-white text-xs'>4</p></div>
    ...
    <Link to='/product' className='flex-col  max-w-[195px] md:max-w-[245px] w-full justify-center items-center'>
        <div className=' h-7 w-7  md:mx-4 rounded-full bg-blue-900  '><p className='p-1 text-white text-xs'>5</p></div>
