      ...
      <div className="lg:flex  lg:max-w-[1370px] md:max-w-[738px] max-[638px]:max-w-[395px] w-full justify-center mt-4 mx-auto lg:px-4 sm:grid sm:grid-cols-3   md:grid md:grid-cols-3 max-[638px]:grid max-[638px]:grid-cols-2  ">
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top1} className="w-[120px] h-[120px] px-10"></img>
          </div>
          <div>
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top2} className="w-[120px] h-[120px] "></img>
          </div>
          <div>
            <p className="text-xs ">
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top3} className="w-[120px] h-[120px] "></img>
          </div>
          <div>
            <p className="text-xs text-[#362D2D]">
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top4} className="w-[120px] h-[120px] px-10"></img>
          </div>
          <div>
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top5} className="w-[120px] h-[120px] py-5 "></img>
          </div>
          <div>
        ...
        >
          ...
          <div className="flex max-w-[195px] md:max-w-[221px]  mx-auto w-full h-[135px]  items-center justify-center">
            <img src={top6} className="w-[120px] h-[120px] px-2"></img>
          </div>
          <div>
            <p className="text-xs text-[#362D2D]">
